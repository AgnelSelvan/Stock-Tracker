...
class CompanyDetailsModel {
  ...
  factory CompanyDetailsModel.fromJson(String source) =>
      CompanyDetailsModel.fromMap(json.decode(source) as Map<String, dynamic>);

  @override
  String toString() {
    return 'CompanyDetailsModel(companyName: $companyName, address: $address, state: $state, pincode: $pincode, emailId: $emailId, website: $website, licNo: $licNo, placeOfDispatch: $placeOfDispatch, pan: $pan, mobileNos: $mobileNos, gstin: $gstin, bankIds: $bankIds, createdAt: $createdAt)';
  }

  @override
  bool operator ==(covariant CompanyDetailsModel other) {
